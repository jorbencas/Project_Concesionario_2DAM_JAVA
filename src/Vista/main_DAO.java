    ...
    static void menuCRUD(Connection con) throws Exception {
        ...
        while (opcion2 != 5) {
            ...
            switch (opcion2) {
                        ...
                        Scanner tecladoec = new Scanner(System.in);
                         elección = tecladoec.nextLine();
                            if(emp.findByDNI(con, elección) != null){
                                System.out.println("Error, el empleado ya existente");
                            }else{
                ...
                case 2:
                    if (tipo == "Empleado") {
                        System.out.println("Hola " + tipo + " estas realizando la opcion de leer");
                        ArrayList<Empleado> empleados = emp.selecionarempleados(con);
                        for (int i = 0; i < empleados.size(); i++) {
                            Empleado empleado2 = new Empleado();
                            empleado2 = empleados.get(i);
                            System.out.println("Tipo de empleado: " + empleado2.toString());
                        }
                    } else if (tipo == "Vehiculo") {
                        System.out.println("Hola " + tipo + " estas realizando la opcion de leer");
                        ArrayList<Vehiculo> vehi = venta.selecionarvehiculos(con);
